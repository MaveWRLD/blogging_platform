...
import org.amalitech.config.MongoConfig;

import org.amalitech.dao.CommentDao;
...
public class PerformanceReporter {
    ...
    public PerformanceReporter(PostDao postDao, CommentDao commentDao) {
    ...
    public void generateComparisonReport(Map<String, PerformanceMetrics> preMetrics,
        ...
        try (FileWriter writer = new FileWriter(filename)) {
            ...
            for (Map.Entry<String, PerformanceMetrics> entry : preMetrics.entrySet()) {
                ...
                writer.write("Pre-Optimization:\n");
                writeStatistics(writer, pre);

                if (post != null) {
                    writer.write("Post-Optimization:\n");
                    writeStatistics(writer, post);
    ...
    private void writeStatistics(FileWriter writer, PerformanceMetrics pre) throws IOException {
