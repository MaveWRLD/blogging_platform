...
import org.amalitech.post.PostMetricsService;
...
public class PostController implements PostApi {
    ...
    public ResponseEntity<CustomApiResponse<PostWithCommentsDto>> getPost(
        ...
        Result result = toResult(post, comments);
        var postResponse = postMapper.toDtoWithComments(result.postDto(), result.commentDtos());
        postResponse.setTotalComments(result.commentDtos().size());
    ...
    private Result toResult(Post post, List<Comment> comments) {
