...
class PostServiceTest {
    ...
    class CreatePost {
        ...
        @Test
        @DisplayName("creates post with resolved tags and default user")
        ...
        @Test
        @DisplayName("throws NoSuchElementException when default user (id=1) not found")
        void userNotFound_throwsException() {
            when(tagService.findOrCreateTagsByName(anySet())).thenReturn(Set.of());
        ...
        @Test
        @DisplayName("calls PostValidator.validateForCreation")
        void callsValidator() {
            try (MockedStatic<PostValidator> validatorMock = mockStatic(PostValidator.class)) {
    ...
    class UpdatePost {
        ...
        void validUpdate_setsUpdatedAt() {
            try (MockedStatic<PostValidator> validatorMock = mockStatic(PostValidator.class)) {
                ...
                postService.updatePost(samplePost, null);
        ...
        @Test
        @DisplayName("sets publishedAt when status is PUBLISHED and publishedAt is null")
        void published_setsPublishedAt() {
            samplePost.setStatus(PostStatus.published);
            samplePost.setPublishedAt(null);
            ...
            try (MockedStatic<PostValidator> validatorMock = mockStatic(PostValidator.class)) {
                ...
                assertThat(samplePost.getPublishedAt()).isBetween(before, after);
            }
        }

        @Test
        @DisplayName("does not overwrite publishedAt when already set")
        void alreadyPublished_doesNotOverwritePublishedAt() {
            Instant original = Instant.parse("2024-01-01T00:00:00Z");
            samplePost.setStatus(PostStatus.published);
            samplePost.setPublishedAt(original);
            ...
            try (MockedStatic<PostValidator> validatorMock = mockStatic(PostValidator.class)) {
                ...
                assertThat(samplePost.getPublishedAt()).isEqualTo(original);
            }
        }
        ...
        void withNewTagIds_replacesTagSet() {
            ...
            samplePost.getTags().add(sampleTag); // pre-existing tag
            ...
            try (MockedStatic<PostValidator> validatorMock = mockStatic(PostValidator.class)) {
                ...
                postService.updatePost(samplePost, List.of(2));
        ...
        void missingTagId_throwsResourceNotFoundException() {
            ...
            try (MockedStatic<PostValidator> validatorMock = mockStatic(PostValidator.class)) {
                ...
                assertThatThrownBy(() -> postService.updatePost(samplePost, List.of(1, 999)))
                        .isInstanceOf(ResourceNotFoundException.class)
        ...
        void emptyTagIdList_clearsTags() {
            ...
            try (MockedStatic<PostValidator> validatorMock = mockStatic(PostValidator.class)) {
                ...
                postService.updatePost(samplePost, List.of());
        ...
        @Test
        @DisplayName("skips tag update when newTagIds is null")
        void nullTagIds_doesNotTouchTags() {
            samplePost.getTags().add(sampleTag);
            ...
            try (MockedStatic<PostValidator> validatorMock = mockStatic(PostValidator.class)) {
                ...
                assertThat(samplePost.getTags()).containsExactly(sampleTag);
